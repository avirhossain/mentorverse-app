...
import { ChevronLeft, User, Mail, Phone, Calendar, BadgeDollarSign, Activity } from 'lucide-react';
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-4">
                ...
                <div>
                 ...
                 <Badge variant={mentee.isActive ? 'default' : 'destructive'} className="ml-auto">
          ...
          <CardContent className="mt-4 grid gap-6 md:grid-cols-2">
            <div className="space-y-4">
                ...
                <InfoItem icon={Calendar} label="Joined On" value={format(new Date(mentee.createdAt), 'MMMM d, yyyy')} />
            </div>
             <div className="space-y-4">
                <InfoItem icon={BadgeDollarSign} label="Account Balance" value={formatCurrency(mentee.accountBalance || 0)} />
                <InfoItem icon={Activity} label="Sessions Booked" value={mentee.totalSessionsBooked || 0} />
            </div>
          </CardContent>
        </Card>
      </div>
